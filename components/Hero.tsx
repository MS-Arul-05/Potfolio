...
export default function Hero() {
  ...
  return (
    <section id="top" className="border-b border-line bg-gradient-to-b from-accentSoft/60 to-parchment">
      <div className="container-x grid items-center gap-12 py-24 md:grid-cols-2 md:py-32">
        ...
        <div className="flex flex-col items-center gap-5 animate-fadeUp">
          ...
          <div className="max-w-xs rounded-2xl border border-line bg-white p-4 text-center text-sm text-muted shadow-sm">
